...
var (
	...
	JoulePerKilogramCelsius = newUnit("joule per kilogram degree Celsius", "J/(kg·°C)", SpecificHeat, SI)

	// Other units
	JoulePerGramCelsius                     = newUnit("joule per gram degree Celsius", "J/(g·°C)", SpecificHeat, SI)
	BritishThermalUnitPerPoundFahrenheit = newUnit("British thermal unit per pound degree Fahrenheit", "BTU/(lb·°F)", SpecificHeat)
)
