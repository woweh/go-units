...
func Test_Pressure_Conversions(t *testing.T) {
	conversionTests := []conversionTest{
		...
		{from: "technical atmosphere", to: "pound-force per square inch", exp: 14.223342077, tol: fPtr(1e-6)},

		// Standard atmosphere conversions
		{from: "standard atmosphere", to: "pascal", exp: 101325},
		{from: "standard atmosphere", to: "bar", exp: 1.01325},
		{from: "standard atmosphere", to: "pound-force per square inch", exp: 14.695947504, tol: fPtr(1e-6)},
		{from: "standard atmosphere", to: "torr", exp: 760, tol: fPtr(1e-3)},

		// Bar conversions
		{from: "bar", to: "pascal", exp: 100000},
		{from: "bar", to: "millibar", exp: 1000},
		{from: "bar", to: "pound-force per square inch", exp: 14.503772519, tol: fPtr(1e-6)},
		...
		{from: "meter of Water Column", to: "inch of Water Column", exp: 39.37007874015748, tol: fPtr(1e-5)},
		...
		{from: "meter of Mercury", to: "inch of Mercury", exp: 39.37007874015748, tol: fPtr(1e-6)},

		// PSI conversions
		{from: "pound-force per square inch", to: "pascal", exp: 6894.757889516},
		{from: "pound-force per square inch", to: "bar", exp: 0.06894757},
		{from: "pound-force per square inch", to: "inch of Mercury", exp: 2.03602, tol: fPtr(1e-6)},
		...
		{from: "inch of water gauge", to: "pascal", exp: 249.0889},
		{from: "pound-force per square inch gauge", to: "pascal", exp: 6894.757889516},
	}
