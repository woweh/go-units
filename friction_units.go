...
var (
	...
	MillimeterOfWaterPerMeter = newUnit("millimeter of water column per meter", "mmH2O/m", Friction)

	// Other units
	MeterOfWaterPerMeter              = newUnit("meter of water column per meter", "mH2O/m", Friction)
	PascalPerMeter                    = newUnit("pascal per meter", "Pa/m", Friction, SI)
	FootOfWaterPer100Feet             = newUnit("foot of water per 100 feet", "FT/100ft", Friction)
	InchOfWaterPer100Feet             = newUnit("inch of water per 100 feet", "in-wg/100ft", Friction)
)
