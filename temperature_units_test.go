...
var temperatureConvTests = []conversionTest{
...
func Test_TemperatureConversions(t *testing.T) {
	testConversions(t, temperatureConvTests)
}

func Test_TemperatureSystems(t *testing.T) {
	si := SiSystem
